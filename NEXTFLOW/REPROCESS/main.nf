...
include { bowtie2 } from "./UPSTREAM/bowtie2.nf"
include { tmap } from "./UPSTREAM/tmap.nf"
include { sort_bam as sort_bwa } from "./UPSTREAM/samtools/sort_bam.nf"
include { sort_bam as sort_tmap } from "./UPSTREAM/samtools/sort_bam.nf"
include { sort_bam as sort_bowtie2 } from "./UPSTREAM/samtools/sort_bam.nf"
include { rm_dup as rm_dup_bwa } from "./UPSTREAM/samtools/rm_dup.nf"
include { rm_dup as rm_dup_tmap } from "./UPSTREAM/samtools/rm_dup.nf"
include { rm_dup as rm_dup_bowtie2 } from "./UPSTREAM/samtools/rm_dup.nf"
include { mapped_bam as mapped_bwa } from "./UPSTREAM/samtools/mapped_bam.nf"
include { mapped_bam as mapped_tmap } from "./UPSTREAM/samtools/mapped_bam.nf"
include { mapped_bam as mapped_bowtie2 } from "./UPSTREAM/samtools/mapped_bam.nf"
include { index as index_bwa } from "./UPSTREAM/samtools/index.nf"
include { index as index_tmap } from "./UPSTREAM/samtools/index.nf"
include { index as index_bowtie2 } from "./UPSTREAM/samtools/index.nf"
workflow {
    ...
    // trimmed_fastq = trimmomatic(input_channel)
    ...
    // BWA_MEM mapping
    //--------------------------------------------
    // aligned_bwa = bwa(input_channel, "${params.outdir}/sam_bwa")
    sorted_bwa = sort_bwa(input_channel, "${params.outdir}/sorted_bwa")
